...
hparams = HParams(
    ...
    hop_size=300,  # For 16000Hz, 200 = 12.5 ms (0.0125 * sample_rate)
    win_size=1200,  # For 16000Hz, 800 = 50 ms (If None, win_size = n_fft) (0.05 * sample_rate)
    sample_rate=24000,  # 16000Hz (corresponding to librispeech) (sox --i <filename>)
